setwd('/home/jovyan/YS_project/souporcell/')
library(ggplot2)

annot = read.csv('/nfs/team205/ig7/work_backups/backup_210306/projects/YS/YS_data/A1.210312_lvl5_ys_for_yolk_meta.csv')
